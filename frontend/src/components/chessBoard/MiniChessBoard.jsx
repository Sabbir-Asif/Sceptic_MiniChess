...
const initialBoard = [
  ['blackKing', 'blackQueen', 'blackBishop', 'blackKnight', 'blackRook'],
...
const MiniChessBoard = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto flex flex-col items-center">
      <h1 className="text-4xl font-bold mb-8 text-green-secondary">5x6 Chess Game</h1>
        ...
        <div className="grid grid-cols-5">
          {board.map((row, rowIndex) =>
            row.map((cell, colIndex) => (
              ...
              >
                {cell !== '.' && (
                  <img src={pieceImages[cell]} alt={cell} className="w-20 h-20" />
                )}
              </div>
            ))
          )}
